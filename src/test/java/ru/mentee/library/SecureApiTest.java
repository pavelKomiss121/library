...
class SecureApiTest {
    ...
    @Test
    @Order(5)
    @DisplayName("Should обновить книгу с использованием JWT токена (цепочка: логин -> получение -> изменение)")
    ...
    void shouldUseGroovyLikeJsonPathSyntax() {
        ...
        List<Integer> recentYears = response.path("findAll { it.publicationYear >= 2020 }.publicationYear");
