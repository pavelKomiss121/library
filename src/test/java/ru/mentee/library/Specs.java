...
public class Specs {
  ...
  /**
   * Создает RequestSpecification для аутентифицированных запросов с JWT токеном Использует
   * глобальные настройки RestAssured для baseURI и port
   */
  ...
  /**
   * Создает RequestSpecification для неаутентифицированных запросов Использует глобальные настройки
   * RestAssured для baseURI и port
   */
