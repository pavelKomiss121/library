...
public class BookInfoResponse {
  ...
  public static BookInfoResponse from(OpenLibraryBookDto dto) {
    ...
    return BookInfoResponse.builder()
        ...
        .isbn10(dto.getIdentifiers() != null && dto.getIdentifiers().getIsbn10() != null
            ? dto.getIdentifiers().getIsbn10().get(0)
            : null)
        .isbn13(dto.getIdentifiers() != null && dto.getIdentifiers().getIsbn13() != null
