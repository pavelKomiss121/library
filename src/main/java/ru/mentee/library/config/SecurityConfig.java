...
public class SecurityConfig {
  ...
  /**
   * Генерирует RSA ключевую пару для RS256 ⚠️ В production используйте предварительно
   * сгенерированные ключи из файлов или переменных окружения
   */
  @Bean
        ...
        .authorizeHttpRequests(
            authz ->
                authz
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/books/isbn/**")
                    .permitAll()
