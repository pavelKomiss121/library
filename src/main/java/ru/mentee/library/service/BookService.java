...
public class BookService {
    ...
    public BookInfoResponse getBookInfoByIsbn(String isbn) {
        ...
        try{
            ...
            Map<String, OpenLibraryBookDto> response = openLibraryClient.getBookByIsbn(
                bibkeys, "json", "data"
            );

            OpenLibraryBookDto bookDto = response != null && !response.isEmpty()
    ...
    public Book createBookFromIsbn(String isbn){
        ...
        Book book = Book.builder()
            ...
            .isbn(isbn)
            .author(bookInfo.getAuthors() != null && !bookInfo.getAuthors().isEmpty()
                ? bookInfo.getAuthors().get(0)
                :"Unknown")
            .publicationYear(bookInfo.getPublishDate() != null
                ? extractYear(bookInfo.getPublishDate())
                : null)
            .build();
